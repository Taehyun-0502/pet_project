...
public enum ErrorCode {
    ...
    CHAT_ROOM_FULL(HttpStatus.CONFLICT, "정원이 가득 차 입장할 수 없습니다."),
    WITHDRAW_CHAT_OWNER(HttpStatus.CONFLICT, "방장인 채팅방이 있습니다. 위임하거나 방을 삭제한 뒤 탈퇴할 수 있습니다."),
    ...
    WALK_WEATHER_FETCH_FAILED(HttpStatus.BAD_GATEWAY, "날씨 정보를 가져오지 못했습니다. 잠시 후 다시 시도해 주세요.");
